...
* *GLMNET Model*: We tested on different ranges of regularization parameter $\lambda$ and $\alpha$. The result is `alpha = 0.75`, and `lambda = 0.0015`.
...
* *Neural Network Model*: The best tuned neural network model has 5 hidden units and decay rate of 0.14.
